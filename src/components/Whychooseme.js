  ...
  return (
    <div className='w-full mx-auto lg:py-20 ssm:py-5 ssm:px-5 h-auto servicesBg'>
        <div className='lg:w-[1200px] ssm:w-full mx-auto h-auto  text-center'>
            ...
            <h1 className='lg:text-[55px] ssm:text-[33px] lg:leading-[50px] ssm:leading-[36px] text-white uppercase mt-3'>
        ...
        <div className='w-full mx-auto flex flex-wrap justify-center lg:mt-10 ssm:mt-5 lg:p-10 ssm:p-3'>
            ...
            <div className='lg:w-[120px] ssm:w-[60px] lg:h-[120px] ssm:h-[60px] p-5 mx-auto flex items-center justify-center bg-[#4064E9] shadow-lg shadow-[#4064E9]/50 rounded-full'>
                ...
                <p className='lg:text-[18px] ssm:text-12 text-center text-[#ADACB5] mt-2'>Passionate professional, turning concepts into immersive web experiences.</p>
            </div>
            ...
            <div className='lg:w-[120px] ssm:w-[60px] lg:h-[120px] ssm:h-[60px] p-5 mx-auto flex items-center justify-center bg-[#4064E9] shadow-lg shadow-[#4064E9]/50 rounded-full'>
                ...
                <p className='lg:text-[18px] ssm:text-12 text-center text-[#ADACB5] mt-2'>Committed to perfection, meticulous attention to detail at every pixel.</p>
            </div>
            ...
            <div className='lg:w-[120px] ssm:w-[60px] lg:h-[120px] ssm:h-[60px] p-5 mx-auto flex items-center justify-center bg-[#4064E9] shadow-lg shadow-[#4064E9]/50 rounded-full'>
                ...
                <p className='lg:text-[18px] ssm:text-12 text-center text-[#ADACB5] mt-2'>Infusing art for a unique online presence—turning imagination into digital masterpieces.</p>
            </div>
        </div>
